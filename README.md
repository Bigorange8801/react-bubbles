...
A token is to store information in local storage and hold the infromation.

- [ ] What steps can you take in your web apps to keep your data secure?

shiping the data from server up authentication and the use of cookies will help secure your content.

- [ ] Describe how web servers work.

A web server is a program that uses HTTP to serve the files that form web pages to the users. Send out the request and the database sends back the page.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

CRUD stands for create, read, update, delete. crud retrieves and returns data from an API. 
